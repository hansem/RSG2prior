function plotPC_tp_figure3(fname)
% plotPC_tp_figure3('trajKS_tp_EL_H_bin20_smth40.mat'); cc; % chosen for representative
% plotPC_tp_figure3('trajKS_tp_ER_H_bin20_smth40.mat'); cc;
% plotPC_tp_figure3('trajKS_tp_HL_H_bin20_smth40.mat'); cc;
% plotPC_tp_figure3('trajKS_tp_HR_H_bin20_smth40.mat'); cc;
% plotPC_tp_figure3('trajKS_tp_EL_G_bin20_smth40.mat'); cc;
% plotPC_tp_figure3('trajKS_tp_ER_G_bin20_smth40.mat'); cc;
% plotPC_tp_figure3('trajKS_tp_HL_G_bin20_smth40.mat'); cc;
% plotPC_tp_figure3('trajKS_tp_HR_G_bin20_smth40.mat'); cc;

% plotPC_tp_figure3('trajKS_set2IC_EL_H_bin20_smth40.mat'); waitforbuttonpress; cc; % chosen for representative
% plotPC_tp_figure3('trajKS_set2IC_ER_H_bin20_smth40.mat'); waitforbuttonpress; cc;
% plotPC_tp_figure3('trajKS_set2IC_HL_H_bin20_smth40.mat');waitforbuttonpress;  cc;
% plotPC_tp_figure3('trajKS_set2IC_HR_H_bin20_smth40.mat'); waitforbuttonpress; cc;
% plotPC_tp_figure3('trajKS_set2IC_EL_G_bin20_smth40.mat');waitforbuttonpress;  cc;
% plotPC_tp_figure3('trajKS_set2IC_ER_G_bin20_smth40.mat');waitforbuttonpress;  cc;
% plotPC_tp_figure3('trajKS_set2IC_HL_G_bin20_smth40.mat'); waitforbuttonpress; cc;
% plotPC_tp_figure3('trajKS_set2IC_HR_G_bin20_smth40.mat'); waitforbuttonpress; cc;

% plotPC_tp_figure3('trajKS_set2IC_SEL_H_bin10_smth20.mat'); disp('H SEL'); waitforbuttonpress; cc; % chosen for representative
% plotPC_tp_figure3('trajKS_set2IC_LEL_H_bin10_smth20.mat'); disp('H LEL'); waitforbuttonpress; cc; % chosen for representative
% plotPC_tp_figure3('trajKS_set2IC_SER_H_bin10_smth20.mat'); disp('H SER'); waitforbuttonpress; cc;
% plotPC_tp_figure3('trajKS_set2IC_LER_H_bin10_smth20.mat'); disp('H LER'); waitforbuttonpress; cc;
% plotPC_tp_figure3('trajKS_set2IC_SHL_H_bin10_smth20.mat'); disp('H SHL');waitforbuttonpress;  cc;
% plotPC_tp_figure3('trajKS_set2IC_LHL_H_bin10_smth20.mat'); disp('H LHL');waitforbuttonpress;  cc;
% plotPC_tp_figure3('trajKS_set2IC_SHR_H_bin10_smth20.mat'); disp('H SHR'); waitforbuttonpress; cc;
% plotPC_tp_figure3('trajKS_set2IC_LHR_H_bin10_smth20.mat'); disp('H LHR'); waitforbuttonpress; cc;
% plotPC_tp_figure3('trajKS_set2IC_SEL_G_bin10_smth20.mat'); disp('G SEL');waitforbuttonpress;  cc;
% plotPC_tp_figure3('trajKS_set2IC_LEL_G_bin10_smth20.mat'); disp('G LEL');waitforbuttonpress;  cc;
% plotPC_tp_figure3('trajKS_set2IC_SER_G_bin10_smth20.mat'); disp('G SER');waitforbuttonpress;  cc;
% plotPC_tp_figure3('trajKS_set2IC_LER_G_bin10_smth20.mat'); disp('G LER');waitforbuttonpress;  cc;
% plotPC_tp_figure3('trajKS_set2IC_SHL_G_bin10_smth20.mat'); disp('G SHL'); waitforbuttonpress; cc;
% plotPC_tp_figure3('trajKS_set2IC_LHL_G_bin10_smth20.mat'); disp('G LHL'); waitforbuttonpress; cc;
% plotPC_tp_figure3('trajKS_set2IC_SHR_G_bin10_smth20.mat'); disp('G SHR'); waitforbuttonpress; cc;
% plotPC_tp_figure3('trajKS_set2IC_LHR_G_bin10_smth20.mat'); disp('G LHR'); waitforbuttonpress; cc;
...
elseif strfind(fname,'tp') 
        idMeasProd=1; % 0; % 1; % plotting together
    idMeasOnly=0; % 1; % 0; % 1;
    idAtt=0;
    elseif strfind(fname,'set2IC') 
        idMeasProd=1; % 0; % 1; % plotting together
    idMeasOnly=0; % 1; % 0; % 1;
    idAtt=0;
...
optsExpFig.FontMode='fixed';
                optsExpFig.Format='png'; % 'eps'; % 'eps'; % 'tiff'; % 'pdf'; % 'png';
optsExpFig.LockAxes=1;
optsExpFig.LineMode='fixed'; % 'scaled';
optsExpFig.LineWidth=1;
...
idEp=i; % only matters if figures are exported
...
%         if ~isempty(strfind(fname,'set2IC_S')) & ~isempty(strfind(fname,'set2IC_L'))
        ...
        % find longest time
            if length(tmpD(end).epochStarts)>1
        ...
        for i=1:length(tmpD)
            ...
            tmpX=tmpD(i).data(1,1);
            tmpY=tmpD(i).data(2,1);
            tmpZ=tmpD(i).data(3,1);
            
            figure(hFig4);
            plot(endPre,tmpX(1),'o',...
                'markerfacecolor',tmpCmap{idPr,1}(i-(idPr-1)*nTs,:),'markeredgecolor','k','markersize',msize,'linewidth',lw2);
            
            figure(hFig42);
            plot(endPre,tmpY(1),'o',...
                'markerfacecolor',tmpCmap{idPr,1}(i-(idPr-1)*nTs,:),'markeredgecolor','k','markersize',msize,'linewidth',lw2);
            
            figure(hFig43);            
            plot(endPre,tmpZ(1),'o',...
                'markerfacecolor',tmpCmap{idPr,1}(i-(idPr-1)*nTs,:),'markeredgecolor','k','markersize',msize,'linewidth',lw2);
...
%         end % if ~strfind(fname,'set2IC_S') & ~strfind(fname,'set2IC_L')
...
% if idExpFig
%     drawnow;
%     savefig(hFig,fullfile(figDir,'3PC',['PC1_' epNm{idEp} '_ready_' ehNm{iEH}(1) targNm{iTh}(1) '_' animalNm{idAnimal} '.fig'])); % ['periSet4_measOnly_' ehNm{iEH} targNm{iTh} '_PC1PC2PC3.fig']);
%     exportfig(hFig,fullfile(figDir,'3PC',['PC1_' epNm{idEp} '_ready_' ehNm{iEH}(1) targNm{iTh}(1) '_' animalNm{idAnimal} '.' optsExpFig.Format]),optsExpFig);%             'periSet4_measOnly_' ehNm{iEH} targNm{iTh} '_PC1PC2PC3_splitTp.png'],optsExpFig);
% end
% 
...
% if idExpFig
%     drawnow;
%     savefig(hFig2,fullfile(figDir,'3PC',['PC2_' epNm{idEp} '_ready_' ehNm{iEH}(1) targNm{iTh}(1) '_' animalNm{idAnimal} '.fig'])); % ['periSet4_measOnly_' ehNm{iEH} targNm{iTh} '_PC1PC2PC3.fig']);
%     exportfig(hFig2,fullfile(figDir,'3PC',['PC2_' epNm{idEp} '_ready_' ehNm{iEH}(1) targNm{iTh}(1) '_' animalNm{idAnimal} '.' optsExpFig.Format]),optsExpFig);%             'periSet4_measOnly_' ehNm{iEH} targNm{iTh} '_PC1PC2PC3_splitTp.png'],optsExpFig);
% end
% 
...
% if idExpFig
%     drawnow;
%     savefig(hFig3,fullfile(figDir,'3PC',['PC3_' epNm{idEp} '_ready_' ehNm{iEH}(1) targNm{iTh}(1) '_' animalNm{idAnimal} '.fig'])); % ['periSet4_measOnly_' ehNm{iEH} targNm{iTh} '_PC1PC2PC3.fig']);
%     exportfig(hFig3,fullfile(figDir,'3PC',['PC3_' epNm{idEp} '_ready_' ehNm{iEH}(1) targNm{iTh}(1) '_' animalNm{idAnimal} '.' optsExpFig.Format]),optsExpFig);%             'periSet4_measOnly_' ehNm{iEH} targNm{iTh} '_PC1PC2PC3_splitTp.png'],optsExpFig);
% end
% 
% end % if idMeasOnly || idMeasProd
...
ylim([tmpMin(1) tmpMax(1)]);
plotVertical(gca,0,[]);
set(gca,'tickdir','out','TickLength', [.02 .02],'xtick',[0 max(T{1})/4-binSize max(T{1})/2-binSize max(T{1})-binSize]/binSize, ...% unique([0 -min(T{1}) -mean(T{1}) -max(T{1}) -mean(T{2}) -max(T{2}) min(T{1}) mean(T{1}) max(T{1}) mean(T{2}) max(T{2})]),...
